(function() {
    ...
    function androidScrollFix() {
        ...
        try {
            ...
            if (scrollApplied) {
                alert('Android scroll fix applied!');
            } else {
                alert('Android scroll fix NOT applied!');
            }
        }
    }
    ...
    if (currentUrl.includes('tournaments')) {
        ...
        function adjustGenderSelectHeightAndroid() {
            try {
        ...
        function interceptWindowOpenAndroid() {
            try {
            ...
            try {
                ...
                if (footerWrapper) {
                    ...
                    if (currentUrl.includes('personal-details')) {
                        ...
                        adjustGenderSelectHeightAndroid();
                    } else {
